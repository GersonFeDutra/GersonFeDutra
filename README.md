...
- ⭐ Favorites:
    ...
    - Topics: `Software Engineering`, `Game Development`, `Godot`, `Computer Graphics` [`Open GL`], `Game Design`, `Teaching`
- 📖 Currently learning:
    - `Compilers`
    - `Computer Theory`
    - `Interaction Human-Computer`
    - `Data Science`: `Statistics`
    - `Web-Development`: `NodeJS`, `Typescript`, `Back-End`
...
<img src="profile/top-langs.svg?username=GersonFeDutra&layout=compact&theme=synthwave&hide_border=true&langs_count=10&hide=jupyter%20notebook,html,cmake" align="right" alt="Top Languages" >
